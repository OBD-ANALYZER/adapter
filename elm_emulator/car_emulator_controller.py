...
class CarEmulatorGUI:
    ...
    def start(self):
        ...
        # Set main window background to light/ocean blue (#0077be)
        ...
        # Configure frame background (light/ocean blue)
        style.configure('TFrame', background='#0077be')
        
        # Configure label colors to be visible on blue background
        ...
        listbox = Listbox(mainframe, 
                         listvariable=presets, 
                         selectmode='browse', 
                         bg='white', 
                         fg='black',
                         selectbackground='#87CEEB',  # Sky blue selection
        ...
        mainframe.rowconfigure([0,3,4,5,6,8], weight=1)
